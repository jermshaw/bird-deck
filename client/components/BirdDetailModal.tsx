              ...
              <div className="space-y-7">
                ...
                <div className="flex items-end justify-center gap-4 px-4">
                  ...
                  <div className="flex flex-col items-center">
                    <svg
                      className={`w-12 h-12 transition-colors duration-200 ${bird.size === 'tiny' ? 'fill-white' : 'fill-white/40'}`}
                      viewBox="0 0 64 64"
                  ...
                  <div className="flex flex-col items-center">
                    <svg
                      className={`w-12 h-12 transition-colors duration-200 ${bird.size === 'small' ? 'fill-white' : 'fill-white/40'}`}
                      viewBox="0 0 64 64"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                  ...
                  <div className="flex flex-col items-center">
                    <svg
                      className={`w-12 h-12 transition-colors duration-200 ${bird.size === 'medium' ? 'fill-white' : 'fill-white/40'}`}
                      viewBox="0 0 64 64"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                  ...
                  <div className="flex flex-col items-center">
                    <svg
                      className={`w-12 h-12 transition-colors duration-200 ${bird.size === 'large' ? 'fill-white' : 'fill-white/40'}`}
                      viewBox="0 0 64 64"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                  ...
                  <div className="flex flex-col items-center">
                    <svg
                      className={`w-12 h-12 transition-colors duration-200 ${bird.size === 'huge' ? 'fill-white' : 'fill-white/40'}`}
                      viewBox="0 0 64 64"
                      xmlns="http://www.w3.org/2000/svg"
                    >
