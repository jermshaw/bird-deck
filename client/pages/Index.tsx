    ...
    >
      ...
      <div className="relative z-10 px-6 py-8 max-w-md mx-auto md:max-w-4xl lg:max-w-6xl lg:px-8">
        ...
        <div className="flex overflow-x-auto pb-4 mb-8">
          ...
          {birdOfTheDay && (
            <div
              className="flex-1 basis-0 min-w-0 h-[460px] rounded-[24px] border-8 border-white relative overflow-hidden cursor-pointer"
              style={{
          ...
          <div className="flex-1 min-w-[280px] h-[460px] rounded-[24px] bg-white relative p-6">
